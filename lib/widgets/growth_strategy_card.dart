...
class _GrowthStrategyCardState extends State<GrowthStrategyCard> {
  ...
  Future<void> _share() async {
    ...
    try {
      ...
      final text = [
        referral['share_text'] ??
            'I’m using My Digital Diary to plan my day, manage my money and track my goals.',
        referral['url'] ?? '',
  ...
  Widget build(BuildContext context) {
    ...
    final steps = activation['steps'] is List
        ? List<dynamic>.from(activation['steps'] as List)
        : const <dynamic>[];
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Expanded(
              child: Column(
                ...
                SizedBox(height: 3),
                Text('Build your own progress, not just your feed.',
                    style: TextStyle(
                        fontSize: 15,
                        height: 1.25,
        ...
        if (steps.isNotEmpty) ...[
          ...
          LinearProgressIndicator(
              value: ((activation['percent'] as num?)?.toDouble() ?? 0) / 100,
              minHeight: 6,
              borderRadius: BorderRadius.circular(99)),
              ...
              children: steps.map((raw) {
                ...
                return Chip(
                    ...
                    avatar: Icon(
                        ...
                        size: 16),
                    label: Text((step['label'] ?? '').toString(),
        ...
        Container(
            ...
            child: Column(
                ...
                children: [
                  const Text('30 DAYS WITH MY DIGITAL DIARY',
                      style: TextStyle(
                          fontSize: 9.5,
                          letterSpacing: .5,
                          fontWeight: FontWeight.w900,
                  ...
                  const Text('Plan, act, record and reflect consistently.',
                      style:
                          TextStyle(fontSize: 10.5, color: Color(0xFF64748B))),
                  if (joined) ...[
                    ...
                    FilledButton(
                        ...
                        child: Text(
                            _joining ? 'Joining…' : 'Join 30-Day Challenge')),
                  ],
                ])),
        ...
        OutlinedButton.icon(
            ...
            label: Text(_sharing ? 'Preparing invite…' : 'Invite a friend')),
        const SizedBox(height: 8),
        Text(
            (trust['message'] ??
                ...
                .toString(),
            style: const TextStyle(
                fontSize: 9.8, height: 1.35, color: Color(0xFF64748B))),
      ]),
    );
  }
}
