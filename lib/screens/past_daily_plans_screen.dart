  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          const Text(
            'Historical progress is calculated for the exact day, including recurring task occurrences.',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        (plan['title'] ?? 'My Daily Plan').toString(),
                      ...
                      Text(
                        '${_i(plan['completed'])} completed · ${_i(plan['pending'])} pending · ${_i(plan['total'])} total',
                        style: const TextStyle(
                          fontSize: 11,
