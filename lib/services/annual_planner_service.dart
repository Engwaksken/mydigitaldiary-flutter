...
class AnnualPlannerService {
  ...
  Future<AnnualPlanSummary> getPlans({
    ...
    return AnnualPlanSummary.fromJson(
  ...
  Future<void> toggle(AnnualPlan plan, bool completed) async =>
      _api.patch('annual-plans/${plan.id}/toggle', {'completed': completed});
  Future<void> delete(int id) => _api.delete('annual-plans/$id');
  Future<void> bulkDelete(List<int> ids) =>
      _api.post('annual-plans/bulk-delete', {'ids': ids});
