...
class Meeting {
  ...
  bool get isRecurring => recurrenceFrequency != null && recurrenceFrequency!.isNotEmpty;
  ...
  factory Meeting.fromJson(Map<String, dynamic> json) {
    return Meeting(
      ...
      recurrenceDaysOfWeek: json['recurrence_days_of_week'] != null ? List<int>.from(json['recurrence_days_of_week']) : const [],
      recurrenceEndsAt: json['recurrence_ends_at'] != null ? DateTime.tryParse(json['recurrence_ends_at'].toString()) : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (recurrenceFrequency != null) 'recurrence_days_of_week': recurrenceDaysOfWeek,
      if (recurrenceFrequency != null) 'recurrence_ends_at': recurrenceEndsAt?.toIso8601String().split('T').first,
    };
  }
}
