...
final List<ModuleConfig> moduleConfigs = [
  const ModuleConfig(
    ...
    fields: [
      ...
      FieldConfig(
          name: 'target_date', label: 'Target Date', type: FieldType.date),
      FieldConfig(
  ...
  const ModuleConfig(
    ...
    fields: [
      ...
      FieldConfig(
          name: 'institution', label: 'Institution', type: FieldType.text),
      FieldConfig(
          name: 'start_date', label: 'Start Date', type: FieldType.date),
      FieldConfig(
  ...
  const ModuleConfig(
    ...
    fields: [
      ...
      FieldConfig(
          name: 'theme_topic', label: 'Theme / Topic', type: FieldType.text),
      FieldConfig(
          name: 'practiced_at',
          label: 'Date',
          type: FieldType.date,
          required: true),
      FieldConfig(
          name: 'practice_time', label: 'Time (HH:MM)', type: FieldType.text),
      FieldConfig(
          name: 'duration_minutes',
          label: 'Duration (minutes)',
          type: FieldType.number),
      ...
      FieldConfig(
          ...
          type: FieldType.date),
      FieldConfig(
          name: 'reflection', label: 'Reflection', type: FieldType.textarea),
    ],
  ),
  const ModuleConfig(
    title: 'Notes',
    ...
    fields: [
      ...
      FieldConfig(
          name: 'is_pinned', label: 'Pinned (1 = yes)', type: FieldType.number),
      FieldConfig(
          name: 'is_favorite',
  ...
  const ModuleConfig(
    ...
    fields: [
      ...
      FieldConfig(
          name: 'title', label: 'Goal', type: FieldType.text, required: true),
      FieldConfig(
          name: 'description',
      ...
      FieldConfig(
          name: 'reminder_at', label: 'Reminder', type: FieldType.datetime),
      FieldConfig(name: 'notes', label: 'Notes', type: FieldType.textarea),
    ],
  ),
  const ModuleConfig(
    ...
    fields: [
      ...
      FieldConfig(
          ...
          type: FieldType.number),
      FieldConfig(
          name: 'steps', label: 'Steps (optional)', type: FieldType.number),
      FieldConfig(
          name: 'mood',
          label: 'Mood',
          type: FieldType.select,
